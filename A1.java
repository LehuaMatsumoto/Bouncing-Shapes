    ...
    * @return toolsPanel        the Panel
    ...
    public JPanel setUpToolsPanel() {
        ...
        xPosText.addActionListener( new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                //set the current x-coordinate based on text in xPos box
                panel.setCurrentXPos(Integer.parseInt(xPosText.getText()));
            }
        });
        ...
        yPosText.addActionListener( new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                //set the current y-coordinate based on text in yPos box
                panel.setCurrentYPos(Integer.parseInt(yPosText.getText()));
            }
        });
        ...
        areaButton.addActionListener( new ActionListener() {
            public void actionPerformed( ActionEvent e) {
                int totalArea = panel.area();
                System.out.println("area: "+totalArea);
                // panel.add(new JLabel("Total area: "+Integer.toString(totalArea), JLabel.LEFT));
            }
        });
